...
With this in hand we then decided to explore the model further as we were confident that the results we produced could be accepted. We introduced \textit{quintessence} by letting $X(z)=(1+z)^{3(1+w)}$ in Equation \ref{eqn:expansion_history}. Quintessence is 
