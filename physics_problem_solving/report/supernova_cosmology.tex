...
we find that within this integral we need to integrate a form of the Friedmann equation between a value for the redshift of the supernova $z$ and no redshift. The form that we require has been derived from Equation \ref{eqn:friedmann_old},
\begin{equation}
H^2 = H_0^2 (1+z)^3 \Omega_{M,0} + H_0^2 \Omega_{\Lambda} - \frac{kc^2}{R^2},
\end{equation}
