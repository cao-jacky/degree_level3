...
Whilst the decline rate parameter is main parameter used in producing the light curves, fitting them requires  \texttt{fit()} function fits light curves to data. It uses a non-linear least-squares algorithm, Levenberg-Marquardt - it minimises $
