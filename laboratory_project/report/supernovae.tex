...
We can calculate the limitiing magnitude that our telescopes could detect by using two different methods, one method is to us the following equation,

\begin{equation}
    L_{mag} = 2 + 5 \log{D_0},
\end{equation}

with $D_0$ being the diameter of our telescopes [[add a table and link to thje derivation]].
