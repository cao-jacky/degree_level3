...
\vspace{-2ex}
Tables \ref{2017hhz-table} and \ref{2017hle-table} contain the calculated magnitudes values with their  associated uncertainties. Equations \ref{mag_counts} and  From this we could then plot our Type Ia supernova light curves and then attempt to perform cosmology with our results.
