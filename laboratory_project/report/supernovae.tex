...
\vspace{-2ex}
With supernovae, there are two basic classifications which are Type I and Type II explosions. The main distinction between them both is that the Type I supernova explosion has an absence of the Balmer series of hydrogen in their optical spectrum at maximum light, and Type II supernovae includes this hydrogen feature \cite{mod_ast, longair}.
...
In Figure \ref{typeia-standard} we can see from multiple observation data, the light curves in B and V bands are generally homogenous. 
\begin{figure}[!h]
\begin{center}
