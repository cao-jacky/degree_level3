...
\vspace{-2ex}
Over a period of 34 days we made observations of 19 different objects, some Type Ia supernovae, a few Type II, and some cataclysmic variables. These objects are given in our objects log in Appendix A, and our individual observations from the entire experiment are detailed in Appendix B.

It was realised early on in our project that it would not feasible for us to track multiple objects for an extended period. This was firstly because observation time had to be distributed equally amongst all the projects within AstroLabs it would be unfair to observe just supernovae for the whole night; secondly with such a large amount of data, we would not be able to process and analyse it all; and thirdly, some of the targets were just not worth observing at all - these objects would be too close to their host galaxy, or they would be too low on the horizon and so could not be viewed from the telescopes in Durham or La Palma.

In choosing which objects to observe, we would initially check supernovae lists which have new discoveries submitted by astronomers. The \textit{Rochester Bright Supernova} \cite{rochester_sn} and \textit{ASAS-SN Supernovae} Lists were the two main sources for us.

For general criterion in choosing supernovae to observe we chose 

After reviewing and considering which objects would provide the best basis for producing Type Ia light curves, our criteria being whether they would be bright enough and if they were close to their host galaxy. In the end chose to observe two supernovae targets, 2017hhz and 2017hle, a Type Ia and Type Ia-91bg respectively.

 this also depended on the conditions and whether it was worth observing if the seeing was bad e.g. obscured by bad weather.
