...
Their usage is important as they 
...
Using samples of nearby (redshift $z \lesssim0.1$) Type Ia supernovae, we can derive a value for Hubble's Constant, $H_0$, by plotting them on a a Hubble diagram \cite{exp_uni_sn} and then using a rearranged form of equation \ref{h_nought}. 
