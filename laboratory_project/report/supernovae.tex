...
\vspace{-2ex}
Throughout the experiment it was important that we kept in mind the uncertainties which arose as this would allow us to produce a final result which could be used to judge the quality of the data, and in turn the entire experiment.



Quantifying these errors allows us to judge whether the data and fittings that we created were good or not. 
