...
\usepackage{graphics,graphicx,epsfig,amsmath,multirow,gensymb,commath,textcomp,natbib,blindtext,mhchem,tabularx,array,makecell,threeparttable}
...
\begin{tabular}{c@{\hskip 20pt}c} 
 ...
 Ia		& Si II line at $616.0$ nm \tnote{\dag} \\
 Ia-91bg	& Absorption trough at $400-450$ nm \tnote{\dag} \\
...
{\item[\dag] in the optical spectra of the supernovae.}
\end{tablenotes}
\label{sn_classes}
\end{threeparttable}
\end{table}
...
\caption[]{Plot showing the general forms of Type Ia supernovae in the B and V bands. The archival supernovae data used to plot this graph are: \em{1994ae, 1994S, 1995bd, 1996bo, }\em  and \em{1998aq }\em \cite{jha, matheson}. The data has not been transformed apart from translated.}
