...
where $m$ is the magnitude of an object, $z$ is the zero-point of the frame, and $C$ is the number of counts we receive from the object \cite{astro_image_processing}.
...
In Table \ref{table:chi2} the $\chi^2$ and reduced $\chi^2$ statistics have been calculated for both supernovae, and for both B and V bands. We also provide the average for $\chi^2_{\nu}$ in both bands. 
...
\begin{tabular}{c@{\hskip 20pt}c@{\hskip 20pt}c@{\hskip 20pt}c@{\hskip 20pt}c} 
 ...
 \hline
\end{tabular}
\caption{$\chi^2$, reduced $\chi^2$ ($\chi^2_{\nu}$) and $\chi^2_{\nu}$ average values are shown for each photometric filter used in our observations (B,V) for each of our supernovae, 2017hhz and 2017hle.}
\label{table:chi2}
\end{table}
